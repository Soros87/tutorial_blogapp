...
func init() {
	file_blogapp_blogapp_post_proto_init()
	md_Post = File_blogapp_blogapp_post_proto.Messages().ByName("Post")
...
func (x *Post) slowProtoReflect() protoreflect.Message {
	mi := &file_blogapp_blogapp_post_proto_msgTypes[0]
...
func (x *fastReflection_Post) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "blogapp.blogapp.Post.title":
		return x.Title != ""
	case "blogapp.blogapp.Post.body":
		return x.Body != ""
	case "blogapp.blogapp.Post.creator":
		return x.Creator != ""
	case "blogapp.blogapp.Post.id":
		return x.Id != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: blogapp.blogapp.Post"))
		}
		panic(fmt.Errorf("message blogapp.blogapp.Post does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Post) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message blogapp.blogapp.Post does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Post) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "blogapp.blogapp.Post.title":
		panic(fmt.Errorf("field title of message blogapp.blogapp.Post is not mutable"))
	case "blogapp.blogapp.Post.body":
		panic(fmt.Errorf("field body of message blogapp.blogapp.Post is not mutable"))
	case "blogapp.blogapp.Post.creator":
		panic(fmt.Errorf("field creator of message blogapp.blogapp.Post is not mutable"))
	case "blogapp.blogapp.Post.id":
		panic(fmt.Errorf("field id of message blogapp.blogapp.Post is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: blogapp.blogapp.Post"))
		}
...
func (x *fastReflection_Post) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in blogapp.blogapp.Post", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: blogapp/blogapp/post.proto
...
func (*Post) Descriptor() ([]byte, []int) {
	return file_blogapp_blogapp_post_proto_rawDescGZIP(), []int{0}
}
...
var File_blogapp_blogapp_post_proto protoreflect.FileDescriptor

var file_blogapp_blogapp_post_proto_rawDesc = []byte{
	0x0a, 0x1a, 0x62, 0x6c, 0x6f, 0x67, 0x61, 0x70, 0x70, 0x2f, 0x62, 0x6c, 0x6f, 0x67, 0x61, 0x70,
	0x70, 0x2f, 0x70, 0x6f, 0x73, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0f, 0x62, 0x6c,
	0x6f, 0x67, 0x61, 0x70, 0x70, 0x2e, 0x62, 0x6c, 0x6f, 0x67, 0x61, 0x70, 0x70, 0x22, 0x5a, 0x0a,
	...
	,
}

var (
	file_blogapp_blogapp_post_proto_rawDescOnce sync.Once
	file_blogapp_blogapp_post_proto_rawDescData = file_blogapp_blogapp_post_proto_rawDesc
)

func file_blogapp_blogapp_post_proto_rawDescGZIP() []byte {
	file_blogapp_blogapp_post_proto_rawDescOnce.Do(func() {
		file_blogapp_blogapp_post_proto_rawDescData = protoimpl.X.CompressGZIP(file_blogapp_blogapp_post_proto_rawDescData)
	})
	return file_blogapp_blogapp_post_proto_rawDescData
}

var file_blogapp_blogapp_post_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_blogapp_blogapp_post_proto_goTypes = []interface{}{
	(*Post)(nil), // 0: blogapp.blogapp.Post
}
var file_blogapp_blogapp_post_proto_depIdxs = []int32{
...
func init() { file_blogapp_blogapp_post_proto_init() }
func file_blogapp_blogapp_post_proto_init() {
	if File_blogapp_blogapp_post_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_blogapp_blogapp_post_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Post); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_blogapp_blogapp_post_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_blogapp_blogapp_post_proto_goTypes,
		DependencyIndexes: file_blogapp_blogapp_post_proto_depIdxs,
		MessageInfos:      file_blogapp_blogapp_post_proto_msgTypes,
	}.Build()
	File_blogapp_blogapp_post_proto = out.File
	file_blogapp_blogapp_post_proto_rawDesc = nil
	file_blogapp_blogapp_post_proto_goTypes = nil
	file_blogapp_blogapp_post_proto_depIdxs = nil
}
